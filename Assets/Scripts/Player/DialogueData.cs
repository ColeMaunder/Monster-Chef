...
public class DialogueData : MonoBehaviour
{
    ...
    "Wow Chef! You’ve really done it!4#The restaurant is going to do so well now!4#But now that you’ve killed the Root of all Evil what are you going to do?1#Oh! I know!2#Why not revisit the other parts of the Swamp?1# You can teach those monsters how to fear you! Beat them up a bunch!3# Congratulations on completing the game, feel free to carry on exploring and beating up monsters in Free Play.1# Good luck Chef! – the dev team1"};
    ...
    "grumble0#grumble grumble0#grumble grumble grumble1#grumble grumble grumble grumble grumble grumble grumble1#grumble grumble grumble2#grumble2",
    ...
    "grumble grumble grumble grumble0#OH CHEF!!!1#CONGRATULATIONS ON DEFEATING THE GREAT EVIL1#Why don’t you keep exploring for a bit?1#Good luck Lil Chef!0"};
    void Start()
    {
    ...
    public int[] GetFaceID(int charicterID,int lineID){
        switch (charicterID)
        {
            case 0:
                ...
                return datalinesSue;
            case 1:
            string[] datalinesBillyString = dialogBilly[lineID].Split("#");
